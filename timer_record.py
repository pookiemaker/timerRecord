...
from makeTimeDir import makemydir
...
subprocess.call(['./Record_from_lineIn.sh'])
...
# setup basic output structure 
filepath = '~/output/'
timestamp =True
prepend ="TestVersion_1_"
workingdir = makemydir(filepath, timestamp, prepend)
print ("----------------------------------------------")
